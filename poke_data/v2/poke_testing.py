...
from poke_data.ApiToCsv import read_pokemon_data
...
def get_two_pokemon(first_pokemon: int, second_pokemon: int, normalize: bool):
    pokemons = read_pokemon_data('./poke_data/data/pokemonAll.csv')
    battles = pd.read_csv("./poke_data/data/v2/battle_data.csv")
